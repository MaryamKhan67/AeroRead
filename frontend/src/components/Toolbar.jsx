            ...
            <div className="flex items-center gap-3 pointer-events-auto">
                ...
                <div className="flex p-1 bg-black/5 dark:bg-white/5 backdrop-blur-md rounded-2xl border border-black/5 dark:border-white/10 shadow-sm">
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 px-4 py-2 rounded-xl text-[10px] uppercase tracking-[0.2em] font-bold transition-all ${readingEngine === 'fidelity'
                            ? 'bg-white dark:bg-gray-800 text-black dark:text-white shadow-xl scale-105'
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 px-4 py-2 rounded-xl text-[10px] uppercase tracking-[0.2em] font-bold transition-all ${readingEngine === 'reflow'
                            ? 'bg-white dark:bg-gray-800 text-black dark:text-white shadow-xl scale-105'
                            : 'opacity-40 hover:opacity-100'
                            }`}
                    >
